    ...
    <aside class="ta-sidebar">
        ...
        <nav class="nav flex-column">
            @if(auth()->user()?->isAdmin())
                ...
                <a class="nav-link {{ request()->routeIs('admin.overtime.*') ? 'active' : '' }}" href="{{ route('admin.overtime.index') }}" title="Penugasan Lembur"><img src="{{ asset('tailadmin-nextjs-1.0.0/src/icons/task.svg') }}" alt="">Penugasan Lembur</a>
            ...
            @else
                ...
                <a class="nav-link {{ request()->routeIs('employee.overtime.*') ? 'active' : '' }}" href="{{ route('employee.overtime.index') }}" title="Jadwal Lembur"><img src="{{ asset('tailadmin-nextjs-1.0.0/src/icons/task.svg') }}" alt="">Jadwal Lembur</a>
